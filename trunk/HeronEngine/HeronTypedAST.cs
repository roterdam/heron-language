...
namespace HeronEngine
{
    ...
    {
        public TypedASTException(string s)
            : base(s)
        {
        }

        public TypedASTException(Exception e)
            : base(e.Message, e)
        {
        }

        public TypedASTException(string s, Exception e)
            : base(s, e)
        {
        }
    }
