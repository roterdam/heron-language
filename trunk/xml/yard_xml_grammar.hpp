...
namespace xml_grammar 
{
	...
	struct LetterCharSet
		: CharSetUnion<
			CharSetUnion<
				CharSetUnion<CharSetRange<'\x41', '\x5A'>, CharSetRange<'\x61', '\x7A'> >,
				CharSetUnion<CharSetRange<'\xC0', '\xD6'>, CharSetRange<'\xD8', '\xF6'> >
			>,
			CharSetRange<'\xF8', '\xFF'>
		>
	{ };
	struct Letter : CharSetParser<LetterCharSet> { };

	struct DigitCharSet
		: CharSetRange<'\x30', '\x39'>
	{ };
