...
namespace Peg
{
    ...
    public class Grammar
    {
        ...
        public static Rule Store(string name, Rule x) { return new StoreRule(name, x); }
        ...
        public static Rule At(Rule x) { return new AtRule(x); }
        ...
        public static Rule AnyCharExcept(Rule r) { return Not(r) + AnyChar; }
        public static Rule AllCharsExcept(Rule r) { return Star(Not(r) + AnyChar); }
        public static Rule UntilPast(Rule r) { return AllCharsExcept(r) + NoFail(r); }
        public static Rule DelimitedCharSeq(Rule rBegin, Rule rEnd) { return rBegin + NoFail(AllCharsExcept(rEnd)) + rEnd; }
        public static Rule StoredDelimitedCharSeq(string name, Rule rBegin, Rule rEnd) { return rBegin + NoFail(Store(name, AllCharsExcept(rEnd))) + rEnd; }
        #endregion

        #region static rule constants
        public static Rule AnyChar = new AnyCharRule();
        public static Rule EndOfInput = new EndOfInputRule();
        public static Rule EndOfLine = CharSeq("\r\n") | CharSeq("\n\r") | CharSeq("\n");
        ...
        static Grammar()
        {
            AssignRuleNames(typeof(Grammar));
        }
    }
}
